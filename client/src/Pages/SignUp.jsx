...
import { AuthContext } from "../Provider/AuthContext"; // Adjust path
    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-b from-secondary to-light">
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        ...
        <div className="flex items-center justify-center space-x-4">
          <button onClick={handleGoogle} className="flex items-center justify-center gap-2 border border-gray-300 rounded-lg px-4 py-2 hover:bg-gray-100 transition">
